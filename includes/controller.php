...
function wpcf7_enqueue_scripts() {
  ...
  wp_register_script( 'QRCode', 'https://cdn.rawgit.com/davidshimjs/qrcodejs/04f46c6a/qrcode.min.js', null, null, true );
	wp_enqueue_script('QRCode');
	wp_register_script( 'GlobalInputMessage', 'https://unpkg.com/global-input-message@1.3.42/lib/global-input-message.min.js', null, null, true );
	wp_enqueue_script('GlobalInputMessage');

	wp_register_script('globalinput', plugin_dir_url(__FILE__) . 'js/global-input.js', array('QRCode','GlobalInputMessage'), '1.0', true);
	wp_enqueue_script('globalinput');
